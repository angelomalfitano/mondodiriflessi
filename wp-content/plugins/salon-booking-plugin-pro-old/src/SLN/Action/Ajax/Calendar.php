...
class SLN_Action_Ajax_Calendar extends SLN_Action_Ajax_Abstract
{
	...
	$total += $discountAmount;
        ...
        $ret = array(
            ...
            "calendar_day_title_assistants"  => $this->getCalendarDayTitleAssistants($booking),
    ...
    private function getBookingServiceTitle($booking, $bookingServiceArray) {
        ...
        foreach($bookingServiceArray['items'] as &$item){
            ...
            $item['title'] = $this->plugin->loadView('admin/_calendar_booking_service_title', compact('bookingService', 'booking'));
        }
