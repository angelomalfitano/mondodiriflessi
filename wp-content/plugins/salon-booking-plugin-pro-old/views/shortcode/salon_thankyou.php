...
$booking = $plugin->getSettings()->get('create_booking_after_pay') ? $plugin->getBookingBuilder() : $plugin->getBookingBuilder()->getLastBooking();
$pendingPayment = $plugin->getSettings()->isPayEnabled() && in_array($booking->getStatus(), array(SLN_Enum_BookingStatus::PENDING_PAYMENT));
